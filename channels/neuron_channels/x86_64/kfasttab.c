...
extern int nrn_get_mechtype();
 ...
 "setdata_K2_mit_usb", _hoc_setdata,
 "rates_K2_mit_usb", _hoc_rates,
 "table_tabktau_K2_mit_usb", _hoc_table_tabktau,
 "tabktau_K2_mit_usb", _hoc_tabktau,
 "table_tabkinf_K2_mit_usb", _hoc_table_tabkinf,
 "tabkinf_K2_mit_usb", _hoc_tabkinf,
 "table_tabntau_K2_mit_usb", _hoc_table_tabntau,
 "tabntau_K2_mit_usb", _hoc_tabntau,
 "table_tabninf_K2_mit_usb", _hoc_table_tabninf,
 "tabninf_K2_mit_usb", _hoc_tabninf,
 0, 0
};
#define table_tabktau table_tabktau_K2_mit_usb
#define tabktau tabktau_K2_mit_usb
#define table_tabkinf table_tabkinf_K2_mit_usb
#define tabkinf tabkinf_K2_mit_usb
#define table_tabntau table_tabntau_K2_mit_usb
#define tabntau tabntau_K2_mit_usb
#define table_tabninf table_tabninf_K2_mit_usb
#define tabninf tabninf_K2_mit_usb
...
#define ktau ktau_K2_mit_usb
 double ktau = 0;
#define kinf kinf_K2_mit_usb
 double kinf = 0;
#define ntau ntau_K2_mit_usb
 double ntau = 0;
#define ninf ninf_K2_mit_usb
 double ninf = 0;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gkbar_K2_mit_usb", 0, 1e+09,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "ntau_K2_mit_usb", "ms",
 "ktau_K2_mit_usb", "ms",
 "gkbar_K2_mit_usb", "mho/cm2",
 "ik_K2_mit_usb", "mA/cm2",
 0,0
};
 ...
 "ninf_K2_mit_usb", &ninf_K2_mit_usb,
 "kinf_K2_mit_usb", &kinf_K2_mit_usb,
 "ntau_K2_mit_usb", &ntau_K2_mit_usb,
 "ktau_K2_mit_usb", &ktau_K2_mit_usb,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 K2_mit_usb /home/aditya/aditya_OB_model/channels/neuron_channels/x86_64/kfasttab.mod\n");
