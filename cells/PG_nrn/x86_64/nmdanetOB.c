...
#define _tqitem &(_ppvar[2]._pvoid)
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 nmdanet /media/data/computational_neuroscience/NEURON_work_win/migliore_etal_2007_backpropagating_APs_in_dendrites_mediate_inhibition/x86_64/nmdanetOB.mod\n");
